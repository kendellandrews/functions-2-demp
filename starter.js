...
// this is an apply disount funtion 
...
const makeSandwich = (bread) => {
    return (ingredients) => {
        let order = `you ordered a ${bread} bread savdwich with `
...
// console.log(makeWheatSandwich(['cheese', 'pickles', 'ham']))
...
const mappedColors  = colors.map((element) => element)
...
//// REDUCE ////
// two variables you need to have is the accumulator and the current value ?
/*
